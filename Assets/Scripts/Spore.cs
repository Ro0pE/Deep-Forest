...
public class Spore : EnemyHealth
{
    protected override string PrefabPath => "Spore"; // Vaihtaa prefab-polun
    ...
    public override void Start()
    {
        ...
        enemySprite = Resources.Load<Sprite>("SporeAvatar");
    ...
    public void AddLootItemsAtStart()
    {
        ...
        minorHealingPotion.dropChance = 777;
        minorManaPotion.dropChance = 777;
    ...
    public override void Die()
    {
        ...
        Debug.Log("Spore died and quest progress updated.");
    }
}
