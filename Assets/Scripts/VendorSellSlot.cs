...
public class VendorSellSlot : MonoBehaviour
{
    ...
    public void SetItem(Item newItem)
    {
        ...
        if (currentItem != null)
        {
            if (itemImage != null)
            {
                ...
                quantityText.text = currentItem.quantity.ToString();  // Näytetään määrä vain stackable esineillä
            }
        ...
        itemValue.text = (currentItem.sellPrice * currentItem.quantity).ToString();
    }
    ...
    {   
        ...
        vendorManager.sellingItems.Remove(currentItem);
