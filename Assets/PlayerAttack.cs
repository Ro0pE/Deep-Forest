...
public class PlayerAttack : MonoBehaviour
{
    ...
    public float magickAttackDamage = 1;
    public float critChance = 0;
    public float hitRating = 0;
    public float baseHitRating = 50f;
    ...
    public float rangedAttackRange = 40f;  // kyhää eri aseita
    public float castingRange = 40f;
    ...
    private IEnumerator PerformAutoAttack()
    {
        ...
        while (isAttacking)
        {
            ...
            {
                Debug.Log("Stopping attack: Enemy out of range or dead");
                StopMeleeAttack();
                yield break;
            }
    ...
    private IEnumerator MeleeCoolDown()
    {
        ...
        {       
                ...
                if (!equipmentManager.UpdateArrowCount(arrow2))
                {
                NoArrows();
    ...
    {
        if (isCasting) return; // Estä taitojen käyttö, jos castaaminen on jo käynnissä
    ...
    public IEnumerator DealDamageAfterDelayMelee()
    {
        if (targetedEnemy != null)
        {
           ...
           // finalDamage += randomVariance;
            ...
            targetedEnemy.TakeDamageMelee(finalDamage, wasCritHit, weaponElement);
