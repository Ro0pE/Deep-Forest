...
public class Spikthorn : EnemyHealth
{
    protected override string PrefabPath => "Spikthorn"; // Vaihtaa prefab-polun
    ...
    public override void Start()
    {
        ...
        monsterName = "Spikthorn";
        monsterLevel = Random.Range(1, 3);
        enemySprite = Resources.Load<Sprite>("SkipthornAvatar");
    ...
    public void AddLootItemsAtStart()
    {
        ...
        Item thorn = itemDatabase.GetItemByName("Thorn"); 
        ...
        Debug.Log("Spikthorn loot added.");
    }
    ...
    public override void Die()
    {
        ...
        Debug.Log("Spikthorn died and quest progress updated.");
    }
}
