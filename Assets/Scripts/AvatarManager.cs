...
public class AvatarManager : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        private IEnumerator ShowDamageText(int damage)
        {
...
public void AssignEnemy(EnemyHealth newEnemyHealth, Sprite newAvatarImage)
{
    ...
    if (enemyHealth != null)
    {
        ...
        EnemyBuffManager enemyBuffManager = enemyHealth.GetComponent<EnemyBuffManager>();
        if (enemyBuffManager != null)
        {
            foreach (Buff buff in enemyBuffManager.activeBuffs)
            {
                ...
                // Luo buffin UI vain, jos sitä ei ole jo
    ...
    private void UpdateHealthBar()
    {
        ...
        if (healthText != null)
        {
            // Jos currentHealth on sama kuin maxHealth, ei näytetä desimaaleja
